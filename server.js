...
io.on('connection', socket => {
    ...
    for (const i in connections) {
        // if connections[i] === null which it will, then playerIndex will become i, it breaks because we found a player. if playerIndex = -1 then we know theres two connections alredy so it remains at -1
